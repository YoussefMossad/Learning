...
import {Quiz, FileUpload, Home, Contact, SignIn, Accounts, MakeExam, ExamPreview, ExamResults, ExamResultDetails, TakeExam, ChapterUpload, ChapterInstall, AdminCourses, Course, DashboardPage, Profile, UploadAssignment, Assignments} from './Pages/index'
          ...
          <Route path = '*' element={
            <>
              <Routes>
                ...
                <Route path = '/MakeExam' element={<InstructorUser Role={role}><MakeExam language={language} isDarkMode={isDarkMode} Role={role} userId={userId}/></InstructorUser>} />
                <Route path = '/ExamPreview' element={<InstructorUser Role={role}><ExamPreview language={language} isDarkMode={isDarkMode} Role={role} userId={userId}/></InstructorUser>} />
                <Route path = '/ExamResults' element={<StudentInstructorUser Role={role}><ExamResults language={language} isDarkMode={isDarkMode} Role={role} userId={userId}/></StudentInstructorUser>} />
                <Route path = '/TakeExam' element={<StudentInstructorUser Role={role}><TakeExam  isDarkMode={isDarkMode} Role={role}/></StudentInstructorUser>} />
                ...
                <Route path = '/ExamResultDetails' element={<StudentInstructorUser Role={role}><ExamResultDetails language={language} isDarkMode={isDarkMode} Role={role} userId={userId}/></StudentInstructorUser>} />
              </Routes>
            </>
          } />
        </Routes>
